...
<title>Digital Signature</title>
	<body class="page-body">
		...
		<form:form class="form-horizontal form-groups-bordered" action="" id="digitalSignatureSearchForm" modelAttribute="digitalSignatureReportList" method="get">
			<header class="navbar navbar-fixed-top"><!-- set fixed position by adding class "navbar-fixed-top" -->
				<nav class="navbar navbar-default navbar-custom navbar-fixed-top">
					<div class="container-fluid">
						<div class="navbar-header col-md-10 col-xs-10">
							<a class="navbar-brand" href="javascript:void(0);">									
								<span class="title2"><spring:message code="lbl.digitalSignature.report.title" /></span>
							</a>
						</div>
					</div>
				</nav>
